...
public class Duke {
    ...
    public static void Event(String command) {
        ...
        try {
            appendToFile("Tasklist.txt", checkdone + "/event/" + event.description + "/" + event.at+System.lineSeparator() );
        }
        catch (IOException e) {
    ...
    public static void Deadline(String command) throws DukeException {
        ...
        try {
            appendToFile("Tasklist.txt", checkdone + "/deadline/" + deadline.description + "/" + deadline.by+System.lineSeparator());
        }
        catch (IOException e) {
            System.out.println(e);
        }
    ...
    public static void Todo(String command) throws DukeException {
        ...
        try {
            appendToFile("Tasklist.txt", checkdone + "/todo/" + newToDoTask.description + System.lineSeparator());
        }
        catch (IOException e) {
            System.out.println(e);
        }
